...
public class Player extends Sprite{
	...
	protected double touchX, touchY, speed;
	private static int TOP_SPEED		= 5;
	protected static int PLAYER_MASS 		= 70;
	protected static double ACCELERATION 	= 2;
	...
	public void onDraw(Canvas canvas){
		...
		rect.set(x+10, y+50, x+bitmap.getWidth()-10, y+bitmap.getHeight()-5);
